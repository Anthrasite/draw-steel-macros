...
- **Ancestries:** All
- **Classes:** Censor (level 1-4), Conduit (level 1-6), Elementalist (level 1-4), Fury (level 1-4), Null (level 1-6), Shadow (level 1-4), Tactician (level 1-6), Talent (level 1), Troubadour (level 1-2)
- **Kits:** All
- **Perks:** All
- **Complications:** All
- **Consumables:** All
