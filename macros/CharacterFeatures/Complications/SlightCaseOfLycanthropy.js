...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Slight Case of Lycanthropy",
  description: `Maybe you were bitten as a child, or maybe it’s a family curse. Either way, you have a malady that is best not discussed in public, lest torches and pitchforks make an appearance.</p>
