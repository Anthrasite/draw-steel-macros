...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Wrathful Spirit",
  description: `You’re quick to anger, never letting an insult go without slinging one right back. In combat, you fight as if possessed by a literal spirit of wrath. No matter the tactical circumstances, when someone injures you, you feel compelled to answer blood with blood.</p>
