...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Cult Victim",
  description: `<p>Cultists captured you while raiding your home, then began an unholy ritual to turn your body into an undead spirit. Though the ritual failed, your body became infused with corrupted magic, turning you partially incorporeal.</p>
