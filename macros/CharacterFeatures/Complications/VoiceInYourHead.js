...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Voice in Your Head",
  description: `You occasionally hear a voice in your head, giving you orders or offering advice. You don’t know who the voice is or why it comes to you, but when you’ve followed the advice, it’s usually proved to be sound.</p>
