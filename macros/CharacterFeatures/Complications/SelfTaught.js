...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Self-Taught",
  description: `While your peers were learning their trades in fancy schools, you honed your capabilities on the mean streets with nothing but your own instinct as a guide. What you lost in polish and tactical acumen, you now make up for in raw power.</p>
