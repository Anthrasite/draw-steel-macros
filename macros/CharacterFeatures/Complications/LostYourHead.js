...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Lost Your Head",
  description: `A bredbeddle stole your head! Usually, being beheaded by one of those magical giants is fatal, but your latent psionic ability allows you to survive despite your decapitation.</p>
