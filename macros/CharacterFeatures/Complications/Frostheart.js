...
await game.macros.getName(`ShareFeature`).execute({
  activeActor: actor,
  name: `Frostheart`,
  description: `<p>At the edge of the world, you were lost in a winter storm and presumed dead. But an unknown fate or power kept you alive, bringing you back with frosty skin and pale eyes.</p>
