...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Raised by Beasts",
  description: `You were orphaned or lost in the wild, and a friendly animal pack (perhaps apes, bears, or wolves) took you in. Returning to so-called civilization was a shock, but you’re now determined to learn all you can about your own kind.</p>
