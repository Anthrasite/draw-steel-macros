...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "War of Assassins",
  description: `Being in the wrong place at the wrong time saw you caught in the middle of a conflict between two warring assassins’ guilds. Whether by choice or by accident, you wound up helping one faction at the expense of the other.</p>
