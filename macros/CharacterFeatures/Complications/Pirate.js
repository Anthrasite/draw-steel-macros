...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Pirate",
  description: `You have a piratical past (and maybe a piratical present and future as well). Though you’re not well-known ashore, other pirates have a way of recognizing their own.</p>
