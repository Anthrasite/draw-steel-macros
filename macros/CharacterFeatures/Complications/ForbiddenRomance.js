...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Forbidden Romance",
  description: `You are in love with someone powerful, but tragic circumstances mean you cannot be with them. Whether your lover is from a feuding family, betrothed to another, or has been driven from your side, you are fated to always be apart.</p>
