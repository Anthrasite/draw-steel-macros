...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Artifact Bonded",
  description: `A powerful artifact has bonded to you, though you don’t know whether you’re destined to wield the artifact or to destroy it. You’re not powerful enough to use it at the moment, although you might be someday. For now, though, the artifact has no effect beyond getting you in trouble.</p>
