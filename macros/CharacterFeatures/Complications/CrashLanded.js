...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Crash Landed",
  description: `You used to flit around the stars in your own ship. But an ugly run-in with a pirate (or a pirate hunter) has left you marooned on this backwater world. You’re prepared to carve out a life here—at least until you can hitch a ride somewhere else.</p>
