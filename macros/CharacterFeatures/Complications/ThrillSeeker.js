...
await game.macros.getName(`ShareFeature`).execute({
  activeActor: actor,
  name: `Thrill Seeker`,
  description: `<p>You live for danger. Whether in battle or mundane peril, you can transcend your usual limits—and once you’ve tasted that excitement, you want more.</p>
