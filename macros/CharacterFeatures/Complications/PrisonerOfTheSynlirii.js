...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Prisoner of the Synlirii",
  description: `You were captured by the psionic beings known as voiceless talkers. You escaped them, but you can’t escape a feeling that’s lingered since then in the back of your mind—the feeling of being watched.</p>
