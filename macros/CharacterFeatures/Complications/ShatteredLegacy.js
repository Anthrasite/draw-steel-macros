...
await game.macros.getName(`ShareFeature`).execute({
  activeActor: actor,
  name: `Shattered Legacy`,
  description: `<p>You’re the heir to a powerful supernatural treasure that has been in your family for generations. One problem, though: that treasure is broken. Some ancestor of yours sundered it while saving the world. Or maybe they tripped and smashed it on a rock. Either way, it’s your job to fix it.</p>
