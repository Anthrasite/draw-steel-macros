...
await game.macros.getName(`ShareFeature`).execute({
  activeActor: actor,
  name: `Following in the Footsteps`,
  description: `<p>Your personal idol was a mighty hero, and you have modeled yourself after them. From studying the many heroic tales told of them, you hope to someday learn your idol’s most famous battle technique.</p>
