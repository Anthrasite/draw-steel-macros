...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Fiery Ideal",
  description: `A spirit beyond your comprehension instilled in you a special purpose, choosing you to be the guardian of a place, a cause, or a philosophy. The flame that now burns in your soul can sear your enemies—or you if you fall short of expectations.</p>
