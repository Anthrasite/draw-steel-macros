...
await game.macros.getName(`ShareFeature`).execute({
  activeActor: actor,
  name: `Rival`,
  description: `<p>Whatever your accomplishments, you’ll forever measure yourself against a former companion who always seemed to stay one step ahead of you.</p>
