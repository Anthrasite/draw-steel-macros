...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Refugee",
  description: `A hostile army—perhaps the forces of Ajax, the Iron Saint—conquered your homeland. Your family escaped, but you can’t return home until your oppressors are defeated once and for all.</p>
