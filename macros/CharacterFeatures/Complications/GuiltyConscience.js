...
await game.macros.getName(`ShareFeature`).execute({
  activeActor: actor,
  name: `Guilty Conscience`,
  description: `<p>The world is in trouble—and it’s partly your fault. Maybe you helped a villain rise to power or inadvertently released a demon from imprisonment. Now it’s your mission to repair the damage you caused.</p>
