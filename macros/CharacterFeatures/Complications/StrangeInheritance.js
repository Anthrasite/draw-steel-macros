...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Strange Inheritance",
  description: `Your siblings each inherited money or land, but you received a strange, seemingly useless trinket—along with the advice that maybe you weren’t cut out for an ordinary, peaceful life.</p>
