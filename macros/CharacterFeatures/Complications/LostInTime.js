...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Lost in Time",
  description: `<p>In a long-ago age, a cataclysm overtook your city. You weren’t killed, but some arcane accident caused you to be suspended in time until now. Alone, you must navigate the world around you with a head full of outdated memories—and a few ancient secrets.</p>
