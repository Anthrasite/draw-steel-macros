...
await game.macros.getName(`ShareFeature`).execute({
  activeActor: actor,
  name: `Lucky`,
  description: `<p>You’ve always had a lucky streak. When you leave things in the hands of fate, you succeed more than you fail. But luck is fickle—and when you don’t trust it, it deserts you.</p>
