...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Evanesceria",
  description: `<p>You have contracted a rare magical disease called evanesceria. From time to time, you’re not quite yourself—or anyone else either. You simply … vanish, then return later with no memory of your absence.</p>
