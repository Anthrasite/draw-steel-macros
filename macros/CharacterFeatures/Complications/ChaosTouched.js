...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Chaos Touched",
  description: `<p>You came into contact with a mote of pure chaos energy, or were subjected to a supernatural effect or object that fused chaos into your very being. Now you can sprout and retract your limbs in a way that horrifies unprepared onlookers.</p>
