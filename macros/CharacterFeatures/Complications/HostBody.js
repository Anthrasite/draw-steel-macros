...
await game.macros.getName("ShareFeature").execute({
  activeActor: actor,
  name: "Host Body",
  description: `“Do not be alarmed! We are not the humanoid we appear to be. We are an intelligent fungal collective, using this body as a host. No, we are doing nothing unsavory! This body was dead when we found it, and we merely gave it another chance at life. We are friendly. Please put down those torches!”</p>
