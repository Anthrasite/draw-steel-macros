...
await game.macros.getName(`ShareAbility`).execute({
  ...
  effect: `If the target dealt damage to you since the end of your last turn, this strike deals additional damage equal to your ${powerRollStat} score (your choice).`,
